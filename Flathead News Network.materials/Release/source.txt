...
The BBC button is in the Newsroom. Instead of pushing the BBC button: say "Bong!"; request "feeds.bbci.co.uk/news/rss.xml". 

The NASA button is in the Newsroom. Instead of pushing the NASA button: say "Bang!"; request "www.nasa.gov/rss/dyn/breaking_news.rss". 

The WHO button is in the Newsroom. Instead of pushing the WHO button: say "Bing!"; request "www.gallifreyone.com/?feed=rss2". 
